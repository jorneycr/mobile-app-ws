package com.jdlm.app.ws.ui.controller;
...
public class UserController {
	...
	public UserDetailsRequestModel updateUser(@PathVariable String userId,
			@Valid @RequestBody UpdateUserDetailsRequestModel userDetails) {

		UserDetailsRequestModel storedUserDetails = users.get(userId);
